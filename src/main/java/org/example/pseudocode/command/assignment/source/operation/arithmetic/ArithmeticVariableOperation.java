...
public class ArithmeticVariableOperation implements InstructionSequence {
    private final InstructionSequence source;
    private final String variableName;
    private final ArithmeticOperator operator;

    public ArithmeticVariableOperation(InstructionSequence source, String variableName, ArithmeticOperator operator) {
        this.source = source;
